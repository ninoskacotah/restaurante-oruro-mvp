...
| 2026-07-28 | Issue #15 / PR pendiente | Apoyar la definición de la máquina de estados compartida por el bot, el panel y el reparto. | Una propuesta de estados, transiciones, eventos, reglas de stock, reasignación, cancelación, idempotencia y pérdida de señal. | La autora revisó y aprobó el modelo antes de incorporarlo; luego se contrastó con las historias de los tres roles y los criterios del Issue #15. | Se creó `docs/estados-pedido.md` con su tabla y diagrama y se actualizó este registro. |
