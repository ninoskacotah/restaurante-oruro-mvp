...
| 2026-07-28 | Issue #25 / PR pendiente | Apoyar la redacción de la bitácora inicial de decisiones técnicas. | Una propuesta de once registros con contexto, alternativas, decisión, justificación y consecuencias, además de la identificación de temas pendientes. | La autora revisó y aprobó previamente la estructura y las alternativas; luego se contrastaron las decisiones con el stack aprobado, la arquitectura, el documento base y los criterios del Issue #25. | Se creó `docs/decisiones-tecnicas.md` y se actualizó este registro. |
